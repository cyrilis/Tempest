...
SWIFT_CLASS("_TtC6Taylor6Server")
@interface Server : NSObject <GCDAsyncSocketDelegate>
- (SWIFT_NULLABILITY(nonnull) instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (void)stopListening;
- (void)socket:(GCDAsyncSocket * __nonnull)socket didAcceptNewSocket:(GCDAsyncSocket * __nonnull)newSocket;
- (void)socket:(GCDAsyncSocket * __null_unspecified)sock didReadData:(NSData * __null_unspecified)data withTag:(NSInteger)tag;
- (void)socketDidDisconnect:(GCDAsyncSocket * __nonnull)sock withError:(NSError * __nonnull)err;
@end
