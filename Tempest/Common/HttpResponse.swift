...
enum HttpResponse {
    ...
    case RAW(Int, NSData)
    case Custom(HttpResponseBody, [(String, String)]?, Int? )
    ...
    func statusCode() -> Int {
        ...
        case .Custom(_, _, let code): if let cd = code {return cd} else{return 200}
    ...
    func reasonPhrase() -> String {
        ...
        case .Custom(_, _, _)       : return "Custom Headers"
    ...
    func headers() -> [String: String] {
        ...
        case .Custom(_, let hd, _): if let headersObj = hd {
    ...
    func body() -> NSData? {
        ...
        case .Custom(let body, _, _): return body.data()?.dataUsingEncoding(NSUTF8StringEncoding, allowLossyConversion: false)
